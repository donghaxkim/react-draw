...
${u[f].replace(" at new "," at ")}`,b=ie(e);return b&&h.includes("<anonymous>")&&(h=h.replace("<anonymous>",b)),h}while(f>=1&&m>=0);break}}}finally{Uo=!1,Error.prepareStackTrace=n,yi(o),console.error=r,console.warn=i}let a=e?ie(e):"";return a?He(a):""},hl=(e,t)=>{let n=e.tag,o="";switch(n){case Fo:o=He("Activity");break;case Ro:o=Xo(e.type,!0);break;case Oo:o=Xo(e.type.render,!1);break;case ko:case $o:o=Xo(e.type,!1);break;case Po:case _o:case Do:o=He(e.type);break;case Ho:o=He("Lazy");break;case Ao:o=e.child!==t&&t!==null?He("Suspense Fallback"):He("Suspense");break;case Io:o=He("SuspenseList");break;case Vo:o=He("ViewTransition");break;default:return""}return o},yl=e=>{try{let t="",n=e,o=null;do{t+=hl(n,o);let r=n._debugInfo;if(r&&Array.isArray(r))for(let i=r.length-1;i>=0;i--){let a=r[i];typeof a.name=="string"&&(t+=gl(a.name,a.env))}o=n,n=n.return}while(n);return t}catch(t){return t instanceof Error?`
...
`,o)),o!==-1)n=n.slice(0,o);else return"";return n},vl=e=>!!(e.fileName?.startsWith("rsc://")&&e.functionName),xl=(e,t)=>e.fileName===t.fileName&&e.lineNumber===t.lineNumber&&e.columnNumber===t.columnNumber,Cl=e=>{let t=new Map;for(let n of e)for(let o of n.stackFrames){if(!vl(o))continue;let r=o.functionName,i=t.get(r)??[];i.some(a=>xl(a,o))||(i.push(o),t.set(r,i))}return t},El=(e,t,n)=>{if(!e.functionName)return{...e,isServer:!0};let o=t.get(e.functionName);if(!o||o.length===0)return{...e,isServer:!0};let r=n.get(e.functionName)??0,i=o[r%o.length];return n.set(e.functionName,r+1),{...e,isServer:!0,fileName:i.fileName,lineNumber:i.lineNumber,columnNumber:i.columnNumber,source:e.source?.replace(xi,`(${i.fileName}:${i.lineNumber}:${i.columnNumber})`)}},Tl=e=>{let t=[];return zo(e,n=>{if(!ml(n))return;let o=typeof n.type=="string"?n.type:ie(n.type)||"<anonymous>";t.push({componentName:o,stackFrames:Ei(bl(n._debugStack?.stack))})},!0),t},Ne=async(e,t=!0,n)=>{let o=Tl(e),r=Ei(yl(e)),i=Cl(o),a=new Map;return pl(r.map(s=>s.source?.includes(xi)??!1?El(s,i,a):s).filter((s,d,c)=>{if(d===0)return!0;let u=c[d-1];return s.functionName!==u.functionName}),t,n)};var bi=e=>e.split("/").filter(Boolean).length,wl=e=>e.split("/").filter(Boolean)[0]??null,Sl=e=>{let t=e.indexOf("/",1);if(t===-1||bi(e.slice(0,t))!==1)return e;let n=e.slice(t);if(!vi.test(n)||bi(n)<2)return e;let o=wl(n);return!o||o.startsWith("@")||o.length>4?e:n},we=e=>{if(!e||Us.some(i=>i===e))return"";let t=e,n=t.startsWith("http://")||t.startsWith("https://");if(n)try{t=new URL(t).pathname}catch{}if(n&&(t=Sl(t)),t.startsWith("about://React/")){let i=t.slice(14),a=i.indexOf("/"),s=i.indexOf(":");t=a!==-1&&(s===-1||a<s)?i.slice(a+1):i}let o=!0;for(;o;){o=!1;for(let i of js)if(t.startsWith(i)){t=t.slice(i.length),i==="file:///"&&(t=`/${t.replace(/^\/+/,"")}`),o=!0;break}}if(di.test(t)){let i=t.match(di);i&&(t=t.slice(i[0].length))}if(t.startsWith("//")){let i=t.indexOf("/",2);t=i===-1?"":t.slice(i)}let r=t.indexOf("?");if(r!==-1){let i=t.slice(r);Ks.test(i)&&(t=t.slice(0,r))}return t},ke=e=>{let t=we(e);return!(!t||!vi.test(t)||Xs.test(t))};var Ml=new Set(["InnerLayoutRouter","OuterLayoutRouter","RedirectErrorBoundary","RedirectBoundary","HTTPAccessFallbackErrorBoundary","HTTPAccessFallbackBoundary","LoadingBoundary","ErrorBoundary","ScrollAndFocusHandler","InnerScrollAndFocusHandler","RenderFromTemplateContext","DevRootHTTPAccessFallbackBoundary","AppDevOverlayErrorBoundary","AppDevOverlay","HotReload","Router","ErrorBoundaryHandler","AppRouter","ServerRoot","SegmentStateProvider","RootErrorBoundary","Suspense","Fragment","StrictMode","ReplaySsrOnlyErrors","SegmentViewNode","SegmentTrieNode"]);function Ie(e){return!!(Ml.has(e)||e.startsWith("_")||e.startsWith("$")||e.includes("Provider")||e.includes("Context")||e==="Head"||e==="html"||e==="body")}function qo(e){let t=e.tagName.toLowerCase();if(t==="html"||t==="body")return!0;let n=e.getBoundingClientRect(),o=window.innerWidth,r=window.innerHeight;return n.width>=o*.9&&n.height>=r*.9}var Ll=50,Cn=.9,Nl=2147483600,kl=1e3,_t=new WeakMap;function Zo(){_t=new WeakMap}function Rl(e,t){return t.display!=="none"&&t.visibility!=="hidden"&&t.opacity!=="0"}function Pl(e){let t=parseInt(e.zIndex,10);return e.pointerEvents==="none"&&e.position==="fixed"&&!isNaN(t)&&t>=Nl}function Ol(e,t){let n=t.position;if(n!=="fixed"&&n!=="absolute")return!1;let o=e.getBoundingClientRect();if(o.width/window.innerWidth<Cn||o.height/window.innerHeight<Cn)return!1;let r=t.backgroundColor;if(r==="transparent"||r==="rgba(0, 0, 0, 0)"||parseFloat(t.opacity)<.1)return!0;let i=parseInt(t.zIndex,10);return!isNaN(i)&&i>kl}function Dt(e){let t=e instanceof HTMLElement?e.tagName.toLowerCase():"";if(t==="html"||t==="body"||e instanceof HTMLElement&&qo(e)||e.closest("#frameup-root")||e instanceof HTMLElement&&e.hasAttribute("data-frameup-interaction")||e instanceof HTMLElement&&e.hasAttribute("data-frameup-placeholder"))return!1;let n=performance.now(),o=_t.get(e);if(o&&n-o.timestamp<Ll)return o.isValid;let r=window.getComputedStyle(e);return Rl(e,r)?e.clientWidth/window.innerWidth>=Cn&&e.clientHeight/window.innerHeight>=Cn&&(Pl(r)||Ol(e,r))?(_t.set(e,{isValid:!1,timestamp:n}),!1):(_t.set(e,{isValid:!0,timestamp:n}),!0):(_t.set(e,{isValid:!1,timestamp:n}),!1)}var Al=.75,Ni=32,En=3,Tn=20,ki=100,ve=1;function pt(e,t,n){return Math.min(n,Math.max(t,e))}function $l(e){if(e.width<=0||e.height<=0)return[];let t=window.innerWidth,n=window.innerHeight,{x:o,y:r}=e,i=o+e.width,a=r+e.height,s=o+e.width/2,d=r+e.height/2,c=pt(Math.ceil(e.width/Ni),En,Tn),u=pt(Math.ceil(e.height/Ni),En,Tn);if(c*u>ki){let h=Math.sqrt(ki/(c*u));c=pt(Math.floor(c*h),En,Tn),u=pt(Math.floor(u*h),En,Tn)}let p=new Set,f=[],m=(h,b)=>{let L=pt(Math.round(h),0,t-1),S=pt(Math.round(b),0,n-1),_=`${L}:${S}`;p.has(_)||(p.add(_),f.push({x:L,y:S}))};m(o+ve,r+ve),m(i-ve,r+ve),m(o+ve,a-ve),m(i-ve,a-ve),m(s,r+ve),m(s,a-ve),m(o+ve,d),m(i-ve,d),m(s,d);for(let h=0;h<c;h++){let b=o+(h+.5)/c*e.width;for(let L=0;L<u;L++)m(b,r+(L+.5)/u*e.height)}return f}function Ri(e,t=Dt,n=!0){let o={left:e.x,top:e.y,right:e.x+e.width,bottom:e.y+e.height},r=new Set,i=$l(e);for(let d of i)for(let c of document.elementsFromPoint(d.x,d.y))r.add(c);let a=[];for(let d of r){if(!t(d))continue;let c=d.getBoundingClientRect();if(c.width<=0||c.height<=0)continue;let u={left:c.left,top:c.top,right:c.left+c.width,bottom:c.top+c.height};if(n){let p=Math.max(o.left,u.left),f=Math.max(o.top,u.top),m=Math.min(o.right,u.right),h=Math.min(o.bottom,u.bottom),b=Math.max(0,m-p)*Math.max(0,h-f),L=c.width*c.height;L>0&&b/L>=Al&&a.push(d)}else o.left<u.right&&o.right>u.left&&o.top<u.bottom&&o.bottom>u.top&&a.push(d)}let s=a.filter(d=>!a.some(c=>c!==d&&c.contains(d)));return s.sort((d,c)=>{let u=d.compareDocumentPosition(c);return u&Node.DOCUMENT_POSITION_FOLLOWING?-1:u&Node.DOCUMENT_POSITION_PRECEDING?1:0}),s}function mt(e,t,n){return e+(t-e)*n}var Hl=.35,Pi=.3,wn=.5,Il=2,Q=null,N=null,Jo=0,Qo=0,Ft=1,gt=null,oe=null,V=null,W=[],ft=l.accent,_l="rgba(162,89,255,0.08)",Oi="rgba(162,89,255,0.15)",Dl=4,Ai=10,Fl="#ffffff",Vl=ft,zl=1.5,nr=!0,je=null;function Hi(){let e=U();e&&(Q=document.createElement("canvas"),Q.setAttribute("data-frameup-overlay","true"),Q.style.cssText=`
  ...
  `;let d=document.createElement("div");d.style.cssText="position:relative;width:176px;height:120px;",d.appendChild(i),d.appendChild(s),n.appendChild(d);function c(){let y=o.h,E=a.createLinearGradient(0,0,176,0);E.addColorStop(0,`hsl(${y}, 0%, 100%)`),E.addColorStop(1,`hsl(${y}, 100%, 50%)`),a.fillStyle=E,a.fillRect(0,0,176,120);let F=a.createLinearGradient(0,0,0,120);F.addColorStop(0,"rgba(0,0,0,0)"),F.addColorStop(1,"rgba(0,0,0,1)"),a.fillStyle=F,a.fillRect(0,0,176,120);let Z=o.s/100*176,J=(1-o.v/100)*120;s.style.left=`${Z}px`,s.style.top=`${J}px`}let u=!1;i.addEventListener("mousedown",y=>{u=!0,p(y)});function p(y){let E=i.getBoundingClientRect(),F=Math.max(0,Math.min(176,y.clientX-E.left)),Z=Math.max(0,Math.min(120,y.clientY-E.top));o.s=F/176*100,o.v=(1-Z/120)*100,c(),P()}let f=document.createElement("canvas");f.width=176,f.height=14,f.style.cssText="width:176px;height:14px;border-radius:7px;cursor:crosshair;";let m=f.getContext("2d"),h=document.createElement("div");h.style.cssText=`
    width: 10px; height: 10px; border-radius: 50%;
    background: white; box-shadow: ${I.sm};
    position: absolute; pointer-events: none;
    top: 2px; transform: translateX(-50%);
  `;let b=document.createElement("div");b.style.cssText="position:relative;width:176px;height:14px;",b.appendChild(f),b.appendChild(h),n.appendChild(b);function L(){let y=m.createLinearGradient(0,0,176,0);for(let E=0;E<=6;E++)y.addColorStop(E/6,`hsl(${E*60}, 100%, 50%)`);m.fillStyle=y,m.fillRect(0,0,176,14),h.style.left=`${o.h/360*176}px`}let S=!1;f.addEventListener("mousedown",y=>{S=!0,_(y)});function _(y){let E=f.getBoundingClientRect(),F=Math.max(0,Math.min(176,y.clientX-E.left));o.h=F/176*360,L(),c(),P()}let H=document.createElement("input");H.type="text",H.value=Mn(o),H.style.cssText=`
    ...
    padding: 4px 8px;
    outline: none;
  `,H.addEventListener("keydown",y=>{y.key==="Enter"&&H.blur(),y.stopPropagation()}),H.addEventListener("blur",()=>{let y=H.value.trim();if(/^#?[0-9a-fA-F]{6}$/.test(y)){let E=y.startsWith("#")?y:`#${y}`;o=zt(E),c(),L(),P()}else H.value=Mn(o)}),n.appendChild(H);let B=["#000000","#ffffff","#e5484d","#f76b15","#f5d90a","#30a46c","#0091ff","#a259ff"],x=document.createElement("div");x.style.cssText="display:flex;gap:4px;justify-content:center;";for(let y of B){let E=document.createElement("button");E.style.cssText=`
      width: 12px; height: 12px; border-radius: 50%;
      background: ${y};
      border: 1px solid ${l.border};
      cursor: pointer; padding: 0;
      transition: box-shadow ${M.fast};
    `,E.addEventListener("mouseenter",()=>{E.style.boxShadow=I.sm}),E.addEventListener("mouseleave",()=>{E.style.boxShadow="none"}),E.addEventListener("click",()=>{o=zt(y),c(),L(),H.value=y,P()}),x.appendChild(E)}if(n.appendChild(x),e.projectColors&&e.projectColors.length>0){let y=document.createElement("div");y.textContent="Project",y.style.cssText=`
      font-size: 10px;
      color: ${l.textSecondary};
      font-family: ${C};
      margin-top: 2px;
    `,n.appendChild(y);let E=document.createElement("div");E.style.cssText="display:flex;gap:4px;flex-wrap:wrap;max-height:48px;overflow-y:auto;";for(let{token:F,hex:Z}of e.projectColors){let J=document.createElement("button");J.title=F,J.style.cssText=`
        width: 12px; height: 12px; border-radius: 50%;
        background: ${Z};
        border: 1px solid ${l.border};
        cursor: pointer; padding: 0;
        transition: box-shadow ${M.fast};
      `,J.addEventListener("mouseenter",()=>{J.style.boxShadow=I.sm}),J.addEventListener("mouseleave",()=>{J.style.boxShadow="none"}),J.addEventListener("click",()=>{o=zt(Z),c(),L(),H.value=Z,P(),e.onPickedToken?.(F)}),E.appendChild(J)}n.appendChild(E)}function P(){let y=Mn(o);H.value=y,e.onColorChange(y),e.onPickedToken?.(void 0)}t.appendChild(n),Ue=n,c(),L();let se=y=>{u&&p(y),S&&_(y)},le=()=>{u=!1,S=!1};document.addEventListener("mousemove",se),document.addEventListener("mouseup",le);let R=y=>{y.key==="Escape"&&ht()};document.addEventListener("keydown",R,!0);let G=y=>{Ue&&!y.composedPath().includes(Ue)&&ht()};setTimeout(()=>document.addEventListener("mousedown",G,!0),0),n._cleanup=()=>{document.removeEventListener("mousemove",se),document.removeEventListener("mouseup",le),document.removeEventListener("keydown",R,!0),document.removeEventListener("mousedown",G,!0)},n._onClose=e.onClose}function ht(){Ue&&(Ue._cleanup?.(),Ue._onClose?.(),Ue.remove(),Ue=null)}function Xl(e,t,n){let o=document.createElement("div");o.style.cssText=`
    display: flex;
    background: ${l.bgSecondary};
    border-radius: 6px;
    padding: 2px;
  ...
  `.trim().replace(/\n\s*/g," "),u.textContent="content";let p=[];function f(w){let T=document.createElement("span"),pe=r.get(w.key)??w.defaultValue;return T.textContent=_(pe),T.title=w.label,T.style.cssText=`
    ...
    align-items:center;
    gap:2px;
  `.trim().replace(/\n\s*/g," ");let y=x("margin","top");y.style.gridRow="1",y.style.gridColumn="2",y.style.textAlign="center";let E=x("margin","left");E.style.gridRow="2",E.style.gridColumn="1";let F=x("margin","right");F.style.gridRow="2",F.style.gridColumn="3";let Z=x("margin","bottom");Z.style.gridRow="3",Z.style.gridColumn="2",Z.style.textAlign="center";let J=document.createElement("div");J.style.cssText="grid-row:2; grid-column:2;",J.appendChild(c),G.appendChild(y),G.appendChild(E),G.appendChild(J),G.appendChild(F),G.appendChild(Z);let cn=H("margin"),Hs=H("padding"),dn=document.createElement("div");return dn.style.cssText="display:flex; gap:8px; padding:0 4px;",dn.appendChild(cn),dn.appendChild(Hs),d.appendChild(G),s.appendChild(d),a.appendChild(dn),a.appendChild(s),{element:a,setValue(w,T){if(!Ui(w))return;r.set(w,T);let te=p.find(Ze=>Ze.key===w);te&&(te.span.textContent=_(T))},destroy(){}}}var Nn=new Set;function Ki(e){return Nn.has(e)}var kn=[];function qi(e){return kn.push(e),()=>{let t=kn.indexOf(e);t>=0&&kn.splice(t,1)}}var ql={layout:"Layout",spacing:"Spacing",size:"Size",typography:"Typography",background:"Background"},Zl={"number-scrub":Gi,segmented:Yi,"color-swatch":ji,"box-model":Xi},Jl=`
  .prop-section {
